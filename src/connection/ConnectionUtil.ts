...
const connectionStringRemote = `mongodb+srv://${user}:${pwd}${url}${db}`;
const connectionStringLocal = 'mongodb://localhost:27017/test';
const connectionString = process.env.NODE_ENV !== 'production' ? connectionStringLocal : connectionStringRemote;
